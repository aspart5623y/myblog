    ...
    <div class="section">
        <div class="container">
            ...
            <div class="img-group">
                ...
                <form action="{{ route('update.image') }}" id="img-form" method="post" enctype="multipart/form-data">
                    @csrf
            ...
            <a href="{{ route('edit.profile') }}" class="btn btn-secondary my-3">Edit profile</a>
            <hr>
